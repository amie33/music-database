...
<?php
	if(empty($_POST['register']))//submit HASN"T been pressed submit the form for the user to fill out 
	{
		echo '<div class="form">';
			...
			echo '<h1 class="head"> Buy A Band T-SHIRT!</h1>';
			echo '<form method ="post" action="products.php" >';
				echo '<input type="text" value = "'.$fn.'" name ="firstN" placeholder ="Enter First Name">'; 
				echo '<input type="text" value = "'.$ln.'" name ="lastN" placeholder ="Enter Last Name">'; 
				echo '<input type="text" value = "'.$e.'" name ="email" placeholder ="Enter Email">'; 
				echo '<input type="text" value = "'.$ad.'" name ="address" placeholder ="Enter Address">'; 
				echo '<input type="text" value = "'.$p.'" name ="phone" placeholder ="Enter Phone Number">';
				echo '<select name ="tshirt">';
						echo'<option value="'.$t.'" selected disabled >Choose a T-Shirt</option>';
				...
				echo '<select name="color">'; 
						echo '<option value="'.$c.'" selected disabled >Choose a Color</option>';
				...
				echo'<select name = "size">';
						echo'<option value="'.$s.'" selected disabled >Choose a Size</option>';
					...
					echo'<select name= "style">';
						echo'<option value="'.$sty.'" selected disabled >Choose a Style</option>';
					...
					echo'<select name ="quantity">';
						echo'<option value="'.$q.'" selected disabled >Quantity Per Item</option>';
